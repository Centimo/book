...
\emph{Гомотопическая теория типов} это новая ветвь математики, которая сочетает аспекты нескольких различных областей неожиданным способом. Она основана на недавно открытой связи между \emph{теорией гомотопий} и \emph{теорией типов}.
Теория гомотопий является ответвлением алгеобраической топологии и гомологической алгебры, with relationships to higher category theory; while type theory is a branch of mathematical logic and theoretical computer science.
...
гомотопическая теория типов also brings new ideas into the very foundation of mathematics.
...
On the other hand, we have \emph{higher inductive types}, which provide direct, logical descriptions of some of the basic spaces and constructions of теория гомотопий: spheres, cylinders, truncations, localizations, etc.
Both ideas are impossible to capture directly in classical set-theoretic foundations, but when combined in гомотопическая теория типов, they permit an entirely new kind of ``logic of homotopy types''.
\index{foundations}%
...
We emphasize that гомотопическая теория типов is a young field, and univalent foundations is very much a work in progress. 
...
As we will discuss briefly later, there are many aspects of гомотопическая теория типов that are not yet fully understood --- and some that are not even touched upon here. 
...
One problem in understanding type theory from a mathematical point of view, however, has always been that the basic concept of \emph{type} is unlike that of \emph{set} in ways that have been hard to make precise.  We believe that the new idea of regarding types, not as strange sets (perhaps constructed without using classical logic), but as spaces, viewed from the perspective of теория гомотопий, is a significant step forward.  In particular, it solves the problem of understanding how the notion of equality of elements of a type differs from that of elements of a set.

In теория гомотопий one is concerned with spaces
\index{topological!space}%
and continuous mappings between them, 
\index{function!continuous!in classical теория гомотопий}%
...
Гомотопическая теория типов (HoTT) interprets type theory from a homotopical perspective.
In гомотопическая теория типов, we regard the types as ``spaces'' (as studied in теория гомотопий) or higher groupoids, and the logical constructions (such as the product $A\times B$) as homotopy-invariant constructions on these spaces.
...
\end{center}
However, in гомотопическая теория типов we think of it instead as:
\begin{center}
...
We only have ``homotopical'' notions, such as paths between points and homotopies between paths, which also make sense in other models of теория гомотопий (such as simplicial sets).
Thus, it would be more accurate to say that we treat types as \emph{$\infty$-groupoids}\index{.infinity-groupoid@$\infty$-groupoid}; this is a name for the ``invariant objects'' of теория гомотопий which can be presented by topological spaces,
\index{topological!space}%
simplicial sets, or any other model for теория гомотопий.
...
\index{homotopy!type}%
for these objects, suggesting the dual interpretation of ``a type (as in type theory) viewed homotopically'' and ``a space considered from the point of view of теория гомотопий''.
...
The homotopical interpretation fits this same pattern: it clarifies the nature of \emph{identity} (or equality) in type theory, and allows us to use type-theoretic reasoning in the study of теория гомотопий.
...
In type theory, for every type $A$ there is a (formerly somewhat mysterious) type $\idtypevar{A}$ of identifications of two objects of $A$; in гомотопическая теория типов, this is just the \emph{path space} $A^I$ of all continuous maps $I\to A$ from the unit interval.
\index{unit!interval}%
...
The idea of гомотопическая теория типов arose around 2006 in independent work by Awodey and Warren~\cite{AW} and Voevodsky~\cite{VV}, but it was inspired by 
Hofmann and Streicher's earlier groupoid interpretation~\cite{hs:gpd-typethy}.
Indeed, higher-dimensional category theory (particularly the theory of weak $\infty$-groupoids) is now known to be intimately connected to теория гомотопий, as proposed by Grothendieck and now being studied intensely by mathematicians of both sorts.
The original semantic models of Awodey--Warren and Voevodsky use well-known notions and techniques from теория гомотопий which are now also in use in higher category theory, such as  Quillen model categories and Kan\index{Kan complex} simplicial sets\index{simplicial!sets}.
...
In теория гомотопий, it is natural to consider also ``inductively defined spaces'' which are generated not merely by a collection of \emph{points}, but also by collections of \emph{paths} and higher paths.
...
By using the identification of paths with identities in гомотопическая теория типов, these sort of ``inductively defined spaces'' can be characterized in type theory by ``induction principles'', entirely analogously to classical examples such as the natural numbers and the disjoint union.
The resulting \emph{higher inductive types}
\index{type!higher inductive}%
give a direct ``logical'' way to reason about familiar spaces such as spheres, which (in combination with univalence) can be used to perform familiar arguments from теория гомотопий, such as calculating homotopy groups of spheres, in a purely formal way.
...
Moreover, this is only the tip of the iceberg: many abstract constructions from теория гомотопий, such as homotopy colimits, suspensions, Postnikov towers, localization, completion, and spectrification, can also be expressed as higher inductive types.
...
Thus, the combination of univalence and higher inductive types suggests the possibility of a revolution, of sorts, in the practice of теория гомотопий.
...
only теория гомотопий.  Of course, there are many specific examples of the use of type theory without the new гомотопическая теория типов features to formalize mathematics,
\index{mathematics!formalized}%
...
Unsurprisingly, теория гомотопий and category theory are two of these, but perhaps less obvious is that univalent foundations has something new and interesting to offer even in subjects such as set theory and real analysis.
...
Adopting a new foundational system such as гомотопическая теория типов as the \emph{implicit formal basis} of informal reasoning will require adjusting some of one's instincts and practices.
The present text is intended to serve as an example of this ``new kind of mathematics'', which is still informal, but could now in principle be formalized in гомотопическая теория типов, rather than ZFC, again given enough ingenuity and patience.
...
Accordingly, we can regard a term $a : A$ as both an element of the type $A$ (or in гомотопическая теория типов, a point of the space $A$), and at the same time, a proof of the proposition $A$.
...
In гомотопическая теория типов, there are natural such subclasses arising from the fact that the system of all types, just like spaces in classical теория гомотопий, is ``stratified'' according to the dimensions in which their higher homotopy structure exists or collapses.
...
Moreover, with higher inductive types, we can universally ``truncate'' a type into an $n$-type; in classical теория гомотопий this would be its $n^{\mathrm{th}}$ Postnikov\index{Postnikov tower} section.\index{n-type@$n$-type}
...
Thus, гомотопическая теория типов is compatible with both constructive and classical conceptions of logic, and many more besides.
...
гомотопическая теория типов admits similar models in higher toposes, such as are studied in~\cite{ToenVezzosi02,Rezk05,lurie:higher-topoi}.
...
We do not yet fully understand the new principles introduced by гомотопическая теория типов, such as univalence and higher inductive types, from
...
For instance:
\begin{enumerate}
\item In set-theoretic foundations, at various points in теория гомотопий and category theory one needs the axiom of choice to perform transfinite constructions.
  But with higher inductive types, we can encode these constructions directly and constructively.
  In particular, none of the ``synthetic'' теория гомотопий in \cref{cha:homotopy} requires \LEM{} or \choice{}.
...
At present, гомотопическая теория типов can really only characterize spaces up to homotopy equivalence, which means that these ``discrete spaces'' may only be \emph{homotopy equivalent} to discrete spaces.
...
A more specialized, but no less important, problem is the relation between гомотопическая теория типов and the research on \emph{higher toposes}%
\index{.infinity1-topos@$(\infty,1)$-topos}
currently happening at the intersection of higher category theory and теория гомотопий.
...
More generally, гомотопическая теория типов should be the ``internal language'' of $(\infty,1)$-toposes, just as intuitionistic higher-order logic is the internal language of ordinary 1-toposes.
...
Recent successes in formalizing some facts from basic теория гомотопий and category theory have been encouraging; some of these are described in \cref{cha:homotopy,cha:category-theory}.
Obviously, however, much work remains to be done.

\index{open!problem|)}%

The гомотопическая теория типов community maintains a web site and group blog at \url{http://homotopytypetheory.org}, as well as a discussion email list.
...
\cref{part:foundations}, ``Foundations'', develops the fundamental concepts of гомотопическая теория типов.
...
\cref{part:mathematics}, ``Mathematics'', consists of four chapters that build on the basic notions of \cref{part:foundations} to exhibit some of the new things we can do with univalent foundations in four different areas of mathematics: теория гомотопий (\cref{cha:homotopy}), category theory (\cref{cha:category-theory}), set theory (\cref{cha:set-math}), and real analysis (\cref{cha:real-numbers}).
...
It also introduces the \emph{univalence axiom} (\cref{sec:compute-universe}) --- the first of the two basic innovations of гомотопическая теория типов.
Thus, it is quite basic and we encourage everyone to read it, especially \crefrange{sec:equality}{sec:basics-equivalences}.

\cref{cha:logic} describes how we represent logic in гомотопическая теория типов, and its connection to classical logic as well as to constructive and intuitionistic logic.
...
While these are important subjects in their own rights and provide a deeper understanding of гомотопическая теория типов, for the most part they are not necessary for \cref{part:mathematics}.
...
\cref{cha:hits} introduces the second basic innovation of гомотопическая теория типов --- \emph{higher inductive types} --- with many examples.
...
Of the chapters in \cref{part:mathematics}, \cref{cha:homotopy} (теория гомотопий) is perhaps the most radical.
Univalent foundations has a very different ``synthetic'' approach to теория гомотопий in which homotopy types are the basic objects (namely, the types) rather than being constructed using topological spaces or some other set-theoretic model.
